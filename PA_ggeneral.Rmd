...
```
The mean of total number of steps taken by day is `r promedio`

The median of total number of steps taken by day is `r mediana`
...
** We'll use the mean for 5 - minutes interval to fill the missing values in 
dataset**
...
finde <- aggregate(.~ interval + wday, FUN = mean,data = dato4)
